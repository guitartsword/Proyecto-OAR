...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_myHeaderView_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 29, 5)
    ...
    "myHeaderView\0sectionClicked\0\0index\0"
};
...
const QMetaObject myHeaderView::staticMetaObject = {
    { &QHeaderView::staticMetaObject, qt_meta_stringdata_myHeaderView.data,
      qt_meta_data_myHeaderView,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_myHeaderView.stringdata))
